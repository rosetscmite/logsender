...
if __name__ == '__main__':
    execfile('modifi.py')
    for line in open('./Wanacry/smbscan.txt', 'r'):
        try:
    ...
    for line in open('./Wanacry/ids.txt', 'r'):
        try:
            syslog = Syslog(host='172.16.100.231', port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./Wanacry/sysmon.txt', 'r'):
        try:
            syslog = Syslog(host='172.16.100.231', port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./Wanacry/inside_smbscan.txt', 'r'):
        try:
            syslog = Syslog(host='172.16.100.231', port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./Wanacry/inside_ids.txt', 'r'):
        try:
            syslog = Syslog(host='172.16.100.231', port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./Wanacry/inside_sysmon.txt', 'r'):
        try:
            syslog = Syslog(host='172.16.100.231', port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./Wanacry/inside_smbscan_wrom.txt', 'r'):
        try:
            syslog = Syslog(host='172.16.100.231', port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:

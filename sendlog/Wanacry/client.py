...
if __name__ == '__main__':
    ...
    execfile('modifi.py')
    for line in open('./log/smbscan.txt', 'r'):
        try:
    ...
    for line in open('./log/ids.txt', 'r'):
        try:
            syslog = Syslog(host=ep_address, port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./log/sysmon.txt', 'r'):
        try:
            syslog = Syslog(host=ep_address, port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./log/inside_smbscan.txt', 'r'):
        try:
            syslog = Syslog(host=ep_address, port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./log/inside_ids.txt', 'r'):
        try:
            syslog = Syslog(host=ep_address, port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./log/inside_sysmon.txt', 'r'):
        try:
            syslog = Syslog(host=ep_address, port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
    ...
    for line in open('./log/inside_smbscan_wrom.txt', 'r'):
        try:
            syslog = Syslog(host=ep_address, port=514)
            syslog.send(line, Level.ERR)
        except OSError, exc:
